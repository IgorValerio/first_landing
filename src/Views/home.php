        ...
        <div class="conteudo">
            ...
            <div class="texto">
              ...
              <div class="descricao">
                ...
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quam soluta quos inventore itaque est porro nemo. 
                 Suscipit dolore ipsa ducimus? Consequatur, a! Sapiente nostrum perferendis reiciendis ratione quibusdam a qui.
                 Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere veritatis delectus nesciunt architecto quo totam.
                </p>
                 
              </div>
              <a href="#" class="btn-principal">Veja o video</a>
            </div> 
        </div>
      </div>
</section>
...
<section class="eventos">
    <div class="container">
        <div class="conteudo">
          ...
          <div class="lista">
            <div class="item">
              <img src="<?=URL_BASE?>resources/imagens/evento-01.jpg">
                <div class="texto">
                  <h3 class="titulo">Titulo do Evento 1 vem aqui</h3>
                  <div class="descricao">
                    <p>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloremque aliquam quibusdam nobis ut maxime,
                    ab molestiae fugit reprehenderit odit cum totam magnam nulla impedit minus ex, distinctio, eos blanditiis rerum.
            ...
            <div class="item">
              <img src="<?=URL_BASE?>resources/imagens/evento-02.jpg">
                <div class="texto">
...
<section class="nossos-cursos">
    <div class="container">
        <div class="conteudo">
          ...
          <div class="lista">
            <div class="item">
              <img src="<?=URL_BASE?>resources/imagens/teach-cat.jpg">
                <div class="texto">
                  <h3 class="titulo">Curso 1 - Nome do Treinamento</h3>
                  <div class="descricao">
                    <p>
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloremque aliquam quibusdam nobis ut maxime,
                    ab molestiae fugit reprehenderit odit cum totam magnam nulla impedit minus ex, distinctio, eos blanditiis rerum.
            ...
            <div class="item">
              <img src="<?=URL_BASE?>resources/imagens/teach2-cat.jpg">
                <div class="texto">
                  <h3 class="titulo">Curso 2 - Nome do Treinamento</h3>
                  <div class="descricao">
                    <p>
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloremque aliquam quibusdam nobis ut maxime,
                      ab molestiae fugit reprehenderit odit cum totam magnam nulla impedit minus ex, distinctio, eos blanditiis rerum.
